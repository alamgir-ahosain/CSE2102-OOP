/*
1. Write a program using class to process shopping list for a departmental store.
The list includes details such as the code no and price of each item and perform
the operations like adding, deleting items to the list and printing the total value
of an order.
